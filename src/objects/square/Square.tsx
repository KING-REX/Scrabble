...
export default class Square {
	...
	constructor(
		...
		this.__squareComponent = (
			<SquareComponent
				...
				tileSharedValue={this.__tileState}></SquareComponent>
		);
	}
	...
	public forceTile(tile: Tile): void {
		...
		if (this.isOccupied()) this.removeTile();
	...
	public updateSquareComponent(length?: number, style?: StyleProp<ViewStyle> | undefined): void {
		...
		console.log(
			"Immediately after the usc function is called, tile is: " +
				this.__tile?.toString() +
				" and tileState is: " +
				this.__tileState?.toString()
		);
		...
		console.log(
			"Later after the usc function is finished, tile is: " +
				this.getTile()?.toString() +
				" and tileState is: " +
				this.__tileState?.toString()
		);
